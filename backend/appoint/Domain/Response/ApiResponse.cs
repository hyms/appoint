...
{
    public ApiResponse(object data, int errorCode,string message = "Error") : base(data, message, errorCode) { }
    public ApiResponse(object data) : base(data) { }
    public ApiResponse(string message, int? errorCode = null) : base(message, errorCode) { }
}
